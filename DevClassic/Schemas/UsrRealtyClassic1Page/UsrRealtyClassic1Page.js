define("UsrRealtyClassic1Page", [], function() {
	return {
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName8060bd9d-cc55-4d1c-81ea-ff5ab1b86263",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATb69ebd47-2cef-497f-9b6a-5e134b5539dd",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT2ebccec6-662d-45aa-b7aa-1ff0520d3d90",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			},
          {                "operation": "insert",
           ...
           "values": {
			...
			{
				"operation": "insert",
				"name": "STRING53f79333-175f-4a0b-95e9-0958c3079238",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
