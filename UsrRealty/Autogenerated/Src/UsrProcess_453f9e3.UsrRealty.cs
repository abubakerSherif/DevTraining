namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_453f9e3MethodsWrapper

	/// <exclude/>
	public class UsrProcess_453f9e3MethodsWrapper : ProcessModel
	{

		public UsrProcess_453f9e3MethodsWrapper(Process process)
			: base(process) {
